...
@pytest.mark.parametrize("state_dictionary_result, state_key", [
    ([
...
@pytest.mark.parametrize("state_dictionary_sortresult, sortway", [
    ([
         {'id': 3412673132, 'state': 'DELAYED', 'date': '2025-05-23T23:07:33.419441'},
    ...
    ([
         ...
         {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
         {'id': 3412673132, 'state': 'DELAYED', 'date': '2025-05-23T23:07:33.419441'},
         {'id': 24112024, 'state': 'REORDERED', 'date': '2025-05-23T23:07:33.419441'}], False),
])
